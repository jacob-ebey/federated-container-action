...
var require_config = __commonJS((exports2) => {
  ...
  async function makeConfig() {
    ...
    return (0, import_webpack_merge.merge)(userConfig, {
      context,
      entry: {noop: import_path2.default.resolve(__dirname, "../noop.js")},
      output: {
        path: import_path2.default.resolve(".container/dist")
      },
      mode: "production",
      plugins: [
